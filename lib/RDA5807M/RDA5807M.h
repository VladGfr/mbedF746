...
void SetThreshold(int threshold); //fonction perso pour définir la sensibilité du seekdown/seekup
bool verifCo();                   //fonction perso pour vérifier la présence du module sur le bus
